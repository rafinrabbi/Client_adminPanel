...
const showProductsAction = (myid)=> dispatch=>{
  console.log(myid, 'action');
   fetch('https://dsp-project-773e5-default-rtdb.firebaseio.com/Products.json')
  .then(res=>res.json())
  .then(data=>dispatch(showAllProduct(data, myid)))
}
