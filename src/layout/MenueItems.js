    ...
    >
      ...
      <Menu.Item key="add-product">
        ...
        <Menu.Item key="edit-category">
          <NavLink onClick={toggleCollapsed} to={`${path}/ecommerce/edit-category`}>
          Edit Category 
          </NavLink>
        </Menu.Item>
        ...
        <Menu.Item key="add-user">
          <NavLink onClick={toggleCollapsed} to={`${path}/ecommerce/add-user`}>
            Add Rider
          </NavLink>
        </Menu.Item>
        <Menu.Item key="rider">
          <NavLink onClick={toggleCollapsed} to={`${path}/ecommerce/rider`}>
            Rider Details
          </NavLink>
        </Menu.Item>
        <Menu.Item key="total-rider">
          <NavLink onClick={toggleCollapsed} to={`${path}/ecommerce/total-rider`}>
            Rider Report
          </NavLink>
        </Menu.Item>
        <Menu.Item key="sellers">
          <NavLink onClick={toggleCollapsed} to={`${path}/ecommerce/users`}>
            Users
          </NavLink>
        </Menu.Item>
